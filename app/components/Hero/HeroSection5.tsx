  ...
  return (
    <div className="h-screen bg-black relative overflow-hidden w-full">
      <nav className=" relative  flex justify-between z-50 items-center px-5 py-3 w-full ">
        ...
        <div>
          <button className="border-2 rounded-xl border-[#FFA503] hover:bg-[#FFA503] duration-150 ease-in-out hover:duration-150 w-[120px] h-[50px]  sm:w-[170.13px] sm:h-[60.05px] text-xl Rubik-SemiBold">
            Login
          </button>
        </div>
      </nav>
        ...
        <div className="px-3 sm:px-4 max-w-3xl relative z-50 ">
          ...
          <div className="relative overflow-hidden flex max-w-3xl items-center ">
            <div className="max-w-[345px] h-[70px] relative overflow-hidden ">
              <svg
                viewBox="0 0 445 75"
                className=" relative w-[250px] h-[70px] sm:w-[345px] sm:h-[70px] "
                fill="none"
            ...
            <svg
              ...
              height="75"
              viewBox="0 0 183 75"
              className=" relative w-[90px] h-[70px] sm:w-[155px] sm:h-[75px] "
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
