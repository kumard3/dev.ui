       ...
       <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
        <div className="flex justify-between items-center   py-6 sm:justify-between sm:space-x-10">
          ...
          <Popover.Group
            ...
            <Link href="/investEarn">Invest and Earn</Link>
            <Link href="/Dev.uiLease">Dev.ui Lease</Link> */}
            {/* <div
              className=" bg-lime-600 text-white font-bold text-lg text-center p-3 px-4 rounded-xl "
              >
              <a href="/reserve" className="btn primary-btn">
                Reserve for ₹501/-
              </a>
            </div> */}
          </Popover.Group>
        ...
        <Popover.Panel
          ...
          <div className="rounded-lg shadow-lg ring-1 h-full ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            ...
            {/* <div className="py-6 px-5 space-y-6">
              <div className="  bg-lime-600 text-white font-bold text-lg text-center p-3 px-4 rounded-xl ">
                <a href="/reserve" className="btn primary-btn">
                  Reserve for ₹501/-
                </a>
              </div>
