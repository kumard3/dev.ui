...
import TabsBasic from "@/components/tab/TabsBasic";
import TabsCard from "@/components/tab/TabsCard";
import TabsVertical from "@/components/tab/TabsVertical";
import HeroSocial from "@/components/Hero/HeroSocial";
import HeroSaaS3 from "@/components/Hero/HeroSaaS3";
import HeroSaaS2 from "@/components/Hero/HeroSaaS2";
import HeroSaaS1 from "@/components/Hero/HeroSaaS1";
...
export const componentMap = {
  ...
  HeroSection6: HeroSection6,
  HeroSection7: HeroSection7,
  HeroSection8: HeroSection8,
  Card7: Card7,
  Card9: Card9,
  Card8: Card8,
